...
/**
 * Realiza la consulta para obtener los datos que serán utilizados para generar el reporte de funciones asignadas a la aplicacion.
 */
public class RepAplicacionFuncionesREP implements ReporteControlIN {
	...
	public Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		String sSql = "SELECT \n"+
					  ...
					  "FROM \n"+
						...
						"RS_CONF_FUNCION C, \n"+
						"RS_CONF_APLICACION D \n"+
					  "WHERE \n"+ 
						"A.CVE_APLICACION = B.CVE_APLICACION \n"+
						"AND D.CVE_APLICACION = B.CVE_APLICACION \n"+

 ...
 */
public class GrupoEmpresaAplicacionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion) throws RemoteException, Exception {
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO) {
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("HerramientasConfiguracionGrupoEmpresaAplicacion", parametros));
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion) throws RemoteException, Exception {
		...
		if (listaAplicaciones != null) {
			...
			registroControl.resultadoCatalogo = catalogoSL.modificacion("HerramientasConfiguracionGrupoEmpresaAplicacion", registro, iTipoOperacion);
		...
		if (iTipoOperacion == CatalogoControl.CON_ALTA) {
			registroControl.sPagina = "/ProcesaCatalogo?Funcion=HerramientasConfiguracionGrupoEmpresa&OperacionCatalogo=CR&CveGpoEmpresa=" + request.getParameter("CveGpoEmpresa");
		}
		else {
			registroControl.sPagina = "/ProcesaCatalogo?Funcion=HerramientasConfiguracionGrupoEmpresa&OperacionCatalogo=CR&CveGpoEmpresa=" + request.getParameter("CveGpoEmpresa");
		}

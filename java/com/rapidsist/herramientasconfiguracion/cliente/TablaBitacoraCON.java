 ...
 * modificación y consulta) del catálogo de tablas relacionadas para bitacorar. 
 * Esta clase es llamada por el servlet {@link CatalogoS CatalogoS}.
 */
public class TablaBitacoraCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("HerramientasConfiguracionTablaBitacora", parametros));
			registroControl.sPagina = "/Aplicaciones/HerramientasConfiguracion/fTablTabConFil.jsp?Funcion=HerramientasConfiguracionTablaBitacora&CveTabla=" + request.getParameter("CveTabla");
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		String sBoton = request.getParameter("btnAlta");
		if (sBoton != null){
		...
		while (lista.hasMoreElements()){
			...
			if (sNombre.startsWith("Tabla")){
				...
				registroTabla.addDefCampo("CVE_TABLA_BITACORA", sClaveTabla);
		...
		if (listaTablas != null){
			...
			registroControl.resultadoCatalogo = catalogoSL.modificacion("HerramientasConfiguracionTablaBitacora", registro, iTipoOperacion);
		}
		else{

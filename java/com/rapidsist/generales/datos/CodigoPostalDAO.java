 ...
 */
public class CodigoPostalDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		boolean bCodigoPostal = false;
		sSql = "SELECT * FROM RS_GRAL_CODIGO_POSTAL \n" +
				 " WHERE \n ";
		if (parametros.getDefCampo("CODIGO_POSTAL") != null){
			sSql = sSql + " CODIGO_POSTAL = '" + (String)parametros.getDefCampo("CODIGO_POSTAL") + "' \n";
			bCodigoPostal = true;
		}
		if (parametros.getDefCampo("NOM_ASENTAMIENTO") != null){
			sSql = sSql + (bCodigoPostal ? " AND" : "") + " NOM_ASENTAMIENTO = '" + (String)parametros.getDefCampo("NOM_ASENTAMIENTO") + "' \n";
		}

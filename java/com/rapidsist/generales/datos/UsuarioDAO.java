 ...
 */
public class UsuarioDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		if (sFiltro.equals("UsuarioAplicacion")){
			sSql = "SELECT U.CVE_GPO_EMPRESA, U.CVE_USUARIO, U.ID_PERSONA, U.LOCALIDAD, U.PASSWORD, U.NOM_ALIAS, P.NOM_COMPLETO  \n"+

...
public class UsuarioCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("GeneralesUsuario", parametros));
			...
			registroControl.sPagina = "/Aplicaciones/Generales/fGralUsuReg.jsp";
		}
			...
			registroControl.sPagina = "/Aplicaciones/Generales/fGralUsuCon.jsp";
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (sCveGpoEmpresa != null){
			if (!sCveGpoEmpresa.equals("")){
				...
				registroControl.sPagina = "/Aplicaciones/Generales/fGralUsuCon.jsp?CveGpoEmpresa=" + sCveGpoEmpresa;
			}
			else{
				registroControl.sPagina = "/Aplicaciones/Generales/fGralUsuCon.jsp";
			}
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("GeneralesUsuario", registro, iTipoOperacion);
		return registroControl;

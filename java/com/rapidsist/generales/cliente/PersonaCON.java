 ...
 */
public class PersonaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("GeneralesPersona", parametros));
			...
			registroControl.sPagina = "/Aplicaciones/Generales/fGralPerCon.jsp";
		}
		else if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Alta")){
				registroControl.respuesta.addDefCampo("ListaPersonalidad", catalogoSL.getRegistros("GeneralesPersonalidadFiscal", parametros));
				registroControl.respuesta.addDefCampo("ListaPais", catalogoSL.getRegistros("GeneralesPais", parametros));
				registroControl.sPagina = "/Aplicaciones/Generales/fGralPerReg.jsp";
			}
			else{
				String sCveGpoEmpresa = request.getParameter("CveGpoEmpresa");
				if (sCveGpoEmpresa == null){
				...
				registroControl.respuesta.addDefCampo("ListaPersonalidad", catalogoSL.getRegistros("GeneralesPersonalidadFiscal", parametros));
				registroControl.respuesta.addDefCampo("ListaPais", catalogoSL.getRegistros("GeneralesPais", parametros));
				registroControl.sPagina = "/Aplicaciones/Generales/fGralPerCon.jsp?CveGpoEmpresa="+sCveGpoEmpresa;
			}
		}
			...
			registroControl.respuesta.addDefCampo("ListaPersonalidad", catalogoSL.getRegistros("GeneralesPersonalidadFiscal", parametros));
			registroControl.respuesta.addDefCampo("ListaPais", catalogoSL.getRegistros("GeneralesPais", parametros));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("GeneralesPersona", parametros));
			//VERIFICA SI SOLO CONSULTA LOS DATOS DEL REGISTRO
			if (request.getParameter("Consulta")!=null){
				registroControl.sPagina = "/Aplicaciones/Generales/fGralPerDat.jsp";
			}
			else{
				registroControl.sPagina = "/Aplicaciones/Generales/fGralPerReg.jsp";
			}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (sCveGpoEmpresa != null){
			if (!sCveGpoEmpresa.equals("")){
				...
				registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesPersona&OperacionCatalogo=CT&CveGpoEmpresa=" + sCveGpoEmpresa + "&NomCompleto=" + sNomCompleto + "&Filtro=RegresaRegistro";
			}
			else{
				registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesPersona&OperacionCatalogo=IN&Filtro=Todos";
			}
		}
		else{
			registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesPersona&OperacionCatalogo=IN&Filtro=Todos";
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("GeneralesPersona", registro, iTipoOperacion);
		return registroControl;
	}
}
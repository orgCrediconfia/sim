 ...
 */
public class UsuarioPerfilCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CatalogoControl.CON_CONSULTA_TABLA){
			...
			registroControl.sPagina = "/Aplicaciones/Generales/fGralUsuPerAlt.jsp";
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (sCveGpoEmpresa != null){
			if (!sCveGpoEmpresa.equals("")){
				...
				registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesUsuario&OperacionCatalogo=CR&CveUsuario=" + request.getParameter("CveUsuario") + "&CveGpoEmpresa=" + sCveGpoEmpresa;
			}
			else{
				registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesUsuario&OperacionCatalogo=CR&CveUsuario=" + request.getParameter("CveUsuario");
			}
		}
		else{
			registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesUsuario&OperacionCatalogo=CR&CveUsuario=" + request.getParameter("CveUsuario");
		...
		if (listaAplicaciones != null){
			...
			registroControl.resultadoCatalogo = catalogoSL.modificacion("GeneralesUsuarioPerfil", registro, iTipoOperacion);
		}
		else{

 ...
 * modificación y consulta) del catálogo de código postal. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class CodigoPostalCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
            ...
            //VERIFICA SI SE RECOLECTARON LOS PARAMETROS PARA OBTENER LA CONSULTA DE LOS CODIGOS
			//POSTALES
			if (bParametrosFiltro){

				registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("GeneralesCodigoPostal", parametros));

			}

			if (!(request.getParameter("FiltroRegresaDatos")== null)){
				Registro registroFiltro = new Registro();
				registroFiltro.addDefCampo("FILTRO_DATOS", request.getParameter("FiltroRegresaDatos"));
				registroControl.respuesta.addDefCampo("registroFiltro", registroFiltro);
			}
			...
			//OBTIENE SOLO EL REGISTRO SOLICITADO
				...
				registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("GeneralesCodigoPostal", parametros));
				registroControl.sPagina = "/Aplicaciones/Generales/fGralCodReg.jsp";
			}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=GeneralesCodigoPostal&OperacionCatalogo=CT&Filtro=Todos&FiltroRegresaDatos="+request.getParameter("FiltroRegresaDatos");

 ...
 */
public class PublAudioDAO	extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion {
	...
	public Registro getRegistro(Registro parametros) throws SQLException{
		...
		if (rs.next()){
			...
			registro.addDefCampo("STREAM",rs.getString("STREAM"));
		}
		return registro;
	}
	...
	public ResultadoCatalogo alta(Registro registro) throws SQLException{
		...
		sSql = "INSERT INTO RS_PUB_PUBLICACION ( \n" +
				...
				"VALUES ( \n"+
					...
					"'" + (String)registro.getDefCampo("STREAM")  + "', \n" +
					"'" + (String)registro.getDefCampo("CONTROLADOR")  + "', \n" +
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		...
		if(registro.getDefCampo("OPERACION_CATALOGO").equals("BA") ){
			...
			sSql = "UPDATE RS_PUB_PUBLICACION SET \n"+
				   ...
				   "CONTROLADOR = '" + (String)registro.getDefCampo("CONTROLADOR") + "', \n" +
				   "STREAM = '" + (String)registro.getDefCampo("STREAM") + "' \n" +
				   "WHERE \n"+
				   "CVE_GPO_EMPRESA ='" + (String)registro.getDefCampo("CVE_GPO_EMPRESA") + "' \n" +
				   "AND CVE_PORTAL = '" + (String)registro.getDefCampo("CVE_PORTAL") + "' \n" +
				   "AND ID_PUBLICACION = '" + (String)registro.getDefCampo("ID_PUBLICACION") + "' \n";

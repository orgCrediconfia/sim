...
/**
 * Administra los accesos a la base de datos para el catálogo de grupos responsable por sección
 */
public class PublGrupoResponsableSeccionDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	 ...
	 * @param parametros Parßmetros que se le envÝan a la consulta para obtener el conjunto
	 ...
	 * @param parametros Parßmetros que se le envÝan a la consulta para obtener el registro
	 * deseado.

 ...
 */
public class MuestraPublicacionS extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			parametros.addDefCampo("CONTADOR", request.getParameter("IncrementaContador"));
			...
			if (request.getParameter("MostrarPublicaciones") != null) {
				...
				if (registroPublicacion != null) {
					...
					String sArchivo = registroPublicacion != null ? (String) registroPublicacion.getDefCampo("URL_PUBLICACION") : "";

 ...
 * modificación y consulta) de las publicaciones de video. Esta clase es llamada por
...
public class PublVideoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN {
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if ((sNombreArchivoVideo.equals("")) || (sTamano.equals(""))){
			...
			resultadoCatalogoControlado.mensaje.setDescripcion("Por favor seleccione el archivo de video que desea publicar o/y el tamaño de la pantalla...");

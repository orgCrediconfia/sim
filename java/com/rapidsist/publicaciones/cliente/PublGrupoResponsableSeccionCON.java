 ...
 */
public class PublGrupoResponsableSeccionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("PublicacionesGrupoResponsableSeccion", parametros));
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (listaUsuarios != null){
			...
			registroControl.resultadoCatalogo = catalogoSL.modificacion("PublicacionesGrupoResponsableSeccion", registro, iTipoOperacion);
		}
		else{
			ResultadoCatalogo resultadoCatalogo = new ResultadoCatalogo();
			registroControl.resultadoCatalogo = resultadoCatalogo;
		}
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=PublicacionesGrupoResponsable&OperacionCatalogo=CR&CveGpoResp=" + request.getParameter("CveGpoResp");
		return registroControl;
	}
}

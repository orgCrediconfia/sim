 ...
 * modificación y consulta) de las cuentas bancarias del Cliente. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimClienteCuentaBancariaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			parametros.addDefCampo("ID_CUENTA",request.getParameter("IdCuenta"));
			registroControl.respuesta.addDefCampo("ListaBanco", catalogoSL.getRegistros("SimCatalogoBanco", parametros));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimClienteCuentaBancaria", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliBan.jsp";
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				parametros.addDefCampo("ID_PERSONA",request.getParameter("IdPersona"));
				registroControl.respuesta.addDefCampo("ListaBanco", catalogoSL.getRegistros("SimCatalogoBanco", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliBan.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdExConyuge="+request.getParameter("IdExConyuge");	
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_CUENTA", request.getParameter("IdCuenta"));
		registro.addDefCampo("CVE_BANCO", request.getParameter("CveBanco"));
		registro.addDefCampo("NUMERO_CUENTA", request.getParameter("NumeroCuenta"));
		registro.addDefCampo("CLABE", request.getParameter("Clabe"));
		
		
		//ACTUALIZA EL REGISTRO EN LA BASE DE DATOS
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimClienteCuentaBancaria", registro, iTipoOperacion);

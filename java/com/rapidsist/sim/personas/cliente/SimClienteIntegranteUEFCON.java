 ...
 * modificación y consulta) de los integrantes de la UEF del Cliente. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimClienteIntegranteUEFCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimClienteIntegranteUEF", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliIntUEFCon.jsp?IdPersona="+request.getParameter("IdPersona");	
		}
		else if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			//RECUPERA CAMPOS
			parametros.addDefCampo("ID_PERSONA",request.getParameter("IdPersona"));
			parametros.addDefCampo("ID_INTEGRANTE",request.getParameter("IdIntegrante"));
			registroControl.respuesta.addDefCampo("ListaParentesco", catalogoSL.getRegistros("SimCatalogoParentesco", parametros));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimClienteIntegranteUEF", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliIntUEFReg.jsp";
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				parametros.addDefCampo("ID_PERSONA",request.getParameter("IdPersona"));
				registroControl.respuesta.addDefCampo("ListaParentesco", catalogoSL.getRegistros("SimCatalogoParentesco", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliIntUEFReg.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdExConyuge="+request.getParameter("IdExConyuge");	
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_INTEGRANTE", request.getParameter("IdIntegrante"));
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimClienteIntegranteUEF", registro, iTipoOperacion);

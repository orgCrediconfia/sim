 ...
 */
public class SimNegocioTelefonoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			//RECUPERA CAMPOS
			parametros.addDefCampo("IDENTIFICADOR",request.getParameter("IdNegocio"));
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimNegocioTelefono", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimNegTel.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdTelefono="+request.getParameter("IdTelefono");
		}
		else if (iTipoOperacion == CatalogoControl.CON_INICIALIZACION){
			//RECUPERA CAMPOS
			if (request.getParameter("Filtro").equals("Alta")){
				registroControl.respuesta.addDefCampo("ListaDescripcionTelefono", catalogoSL.getRegistros("SimCatalogoDescripcionTelefono", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimNegTel.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdNegocio="+request.getParameter("IdNegocio")+"&IdDomicilio="+request.getParameter("IdDomicilio");	
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimNegocioTelefono", registro, iTipoOperacion);
		//INDICA A DONDE IRA AL TERMINAR LA ACTUALIZACION
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimClienteNegocio&OperacionCatalogo=CR&IdPersona="+request.getParameter("IdPersona")+"&IdNegocio="+request.getParameter("IdNegocio")+"&IdDomicilio="+request.getParameter("IdDomicilio")+"&IdExConyuge="+request.getParameter("IdExConyuge");

 ...
 * modificación y consulta) de los teléfonos del Cliente. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimNegocioSecundarioTelefonoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimClienteTelefono", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliTel.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdTelefono="+request.getParameter("IdTelefono");
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				...
				registroControl.respuesta.addDefCampo("ListaDescripcionTelefono", catalogoSL.getRegistros("SimCatalogoDescripcionTelefono", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimNegSecTel.jsp?IdNegocioSecundario="+request.getParameter("IdNegocioSecundario")+"&IdNegocio="+request.getParameter("IdNegocio")+"&IdPersona="+request.getParameter("IdPersona");
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("IDENTIFICADOR",request.getParameter("IdNegocioSecundario"));
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimNegocioSecundarioTelefono", registro, iTipoOperacion);
		//INDICA A DONDE IRA AL TERMINAR LA ACTUALIZACION
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimClienteNegocioSecundario&OperacionCatalogo=CR&IdNegocioSecundario="+request.getParameter("IdNegocioSecundario")+"&IdNegocio="+request.getParameter("IdNegocio")+"&IdPersona="+request.getParameter("IdPersona");

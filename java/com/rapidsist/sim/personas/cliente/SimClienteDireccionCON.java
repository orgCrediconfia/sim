 ...
 * modificación y consulta) de las direcciones de los clientes. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimClienteDireccionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			Registro DomicilioFiscal = new Registro ();
			DomicilioFiscal = catalogoSL.getRegistro("SimClienteDomicilioFiscal", parametros);
			String sDomicilioFiscal = (String)DomicilioFiscal.getDefCampo("DOMICILIO_FISCAL");
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimClienteDireccion", parametros));
			...
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliDir.jsp?IdPersona="+request.getParameter("IdPersona")+"&DomicilioFiscal="+sDomicilioFiscal;
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				...
				String sDomicilioFiscal = (String)DomicilioFiscal.getDefCampo("DOMICILIO_FISCAL");
				registroControl.respuesta.addDefCampo("ListaTipoDomicilio", catalogoSL.getRegistros("SimCatalogoTipoDomicilio", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliDir.jsp?DomicilioFiscal="+sDomicilioFiscal;
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("FECHA_INICIO_RESIDENCIA", request.getParameter("FechaInicioResidencia")!= null ? request.getParameter("FechaInicioResidencia") : "");
		registro.addDefCampo("CVE_TIPO_IDENTIFICADOR","CLIENTE");
		registro.addDefCampo("IDENTIFICADOR",request.getParameter("IdPersona"));
		
		if(request.getParameter("DomicilioFiscalSi")!=null){
			registro.addDefCampo("DOMICILIO_FISCAL","V");
		}else{
			registro.addDefCampo("DOMICILIO_FISCAL","F");
		}
		
		//ACTUALIZA EL REGISTRO EN LA BASE DE DATOS
		
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimClienteDireccion", registro, iTipoOperacion);
		
		if(request.getParameter("IdExConyuge") != ""){
			if(request.getParameter("DomicilioFiscalSi")!=null){
				registro.addDefCampo("CVE_TIPO_IDENTIFICADOR","EXCONYUGE");
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimClienteExConyugeDireccion", registro, iTipoOperacion);
			}
		}

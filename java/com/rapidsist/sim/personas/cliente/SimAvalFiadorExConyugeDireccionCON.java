 ...
 */
public class SimAvalFiadorExConyugeDireccionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimAvalFiadorExConyugeDireccion", parametros));
			...
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaExConDir.jsp?IdPersona="+request.getParameter("IdPersona");
		}
		else if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Alta")){
				registroControl.respuesta.addDefCampo("ListaTipoDomicilio", catalogoSL.getRegistros("SimCatalogoTipoDomicilio", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaExConDir.jsp"; 
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimAvalFiadorExConyugeDireccion", registro, iTipoOperacion);

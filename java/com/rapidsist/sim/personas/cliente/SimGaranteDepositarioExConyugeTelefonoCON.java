 ...
 * modificación y consulta) de los teléfonos del cónyuge o excónyuge del Garante depositario. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimGaranteDepositarioExConyugeTelefonoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimExConyugeTelefono", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimExConTel.jsp?IdPersona="+request.getParameter("IdPersona")+"&IdTelefono="+request.getParameter("IdTelefono");
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				...
				registroControl.respuesta.addDefCampo("ListaDescripcionTelefono", catalogoSL.getRegistros("SimCatalogoDescripcionTelefono", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimGarDepExConTel.jsp?IdPersona="+request.getParameter("IdPersona");	
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimGaranteDepositarioExConyugeTelefono", registro, iTipoOperacion);

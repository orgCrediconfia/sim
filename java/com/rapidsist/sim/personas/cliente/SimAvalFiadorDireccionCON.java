 ...
 * modificación y consulta) de las direcciones del aval o fiador. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimAvalFiadorDireccionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimAvalFiadorDireccion", parametros));
			...
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaDir.jsp?IdPersona="+request.getParameter("IdPersona");
		}
		else if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Alta")){
				registroControl.respuesta.addDefCampo("ListaTipoDomicilio", catalogoSL.getRegistros("SimCatalogoTipoDomicilio", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaDir.jsp";
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_TIPO_DOMICILIO", request.getParameter("IdTipoDomicilio")!= null ? request.getParameter("IdTipoDomicilio") : "");
		registro.addDefCampo("FECHA_INICIO_RESIDENCIA", request.getParameter("FechaInicioResidencia")!= null ? request.getParameter("FechaInicioResidencia") : "");
		registro.addDefCampo("CVE_TIPO_IDENTIFICADOR","AVAL");
		registro.addDefCampo("IDENTIFICADOR",request.getParameter("IdPersona"));
		
		if(request.getParameter("DomicilioFiscalNo")!=null){
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimAvalFiadorDireccion", registro, iTipoOperacion);
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimAvalFiador&OperacionCatalogo=CR&IdPersona="+request.getParameter("IdPersona");
		return registroControl;
	}
}
 ...
 * modificación y consulta) de los garantes depositarios. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimGaranteDepositarioCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimGaranteDepositario", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimGarDepCon.jsp";
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				...
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimGarDepReg.jsp";
			...
			parametros.addDefCampo("ID_PERSONA",request.getParameter("IdPersona"));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimGaranteDepositario", parametros));
			registroControl.respuesta.addDefCampo("registroExConyuge", catalogoSL.getRegistro("SimGaranteDepositarioExConyuge", parametros));	
			registroControl.respuesta.addDefCampo("ListaTelefono", catalogoSL.getRegistros("SimGaranteDepositarioTelefono", parametros));
			registroControl.respuesta.addDefCampo("ListaTelefonoExConyuge", catalogoSL.getRegistros("SimGaranteDepositarioExConyugeTelefono", parametros));
			registroControl.respuesta.addDefCampo("ListaDireccion", catalogoSL.getRegistros("SimGaranteDepositarioDireccion", parametros));
			registroControl.respuesta.addDefCampo("ListaDireccionExConyuge", catalogoSL.getRegistros("SimGaranteDepositarioExConyugeDireccion", parametros));
			registroControl.respuesta.addDefCampo("ListaEscolaridad", catalogoSL.getRegistros("SimCatalogoEscolaridad", parametros));
			registroControl.respuesta.addDefCampo("ListaIdentificacionOficial", catalogoSL.getRegistros("SimCatalogoIdentificacionOficial", parametros));
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (request.getParameter("EstadoCivil").equals("Casado") || request.getParameter("EstadoCivil").equals("Divorciado")){
			if(request.getParameter("IdPersona") == ""){
				...
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimGaranteDepositario", registro, iTipoOperacion);
			}
			else if(request.getParameter("IdPersona") != ""  && request.getParameter("IdExConyuge") == ""){
				
				registro.addDefCampo("MODIFICACION_CONYUGE","NO");
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimGaranteDepositario", registro, iTipoOperacion);
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimGaranteDepositarioExConyuge", registro, 1);
			}else if(request.getParameter("IdPersona") != "" && request.getParameter("IdExConyuge") != ""){
		...
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimGaranteDepositario&OperacionCatalogo=CR&IdPersona="+sIdPersona;

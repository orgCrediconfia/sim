 ...
 * modificación y consulta) de los adeudos del Cliente. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimClienteGarantiaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			parametros.addDefCampo("ID_GARANTIA",request.getParameter("IdGarantia"));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimClienteGarantia", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimCliGarReg.jsp";
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_GARANTIA", request.getParameter("IdGarantia"));
		...
		registro.addDefCampo("NUMERO_FACTURA_ESCRITURA", request.getParameter("NumeroFacturaEscritura"));
		registro.addDefCampo("FECHA_FACTURA_ESCRITURA", request.getParameter("FechaFacturaEscritura"));
		registro.addDefCampo("VALOR_COMERCIAL", request.getParameter("ValorComercial"));
		registro.addDefCampo("VALOR_A_GARANTIZAR", request.getParameter("ValorAGarantizar"));
		registro.addDefCampo("ID_GARANTE_DEPOSITARIO", request.getParameter("IdPersonaGarante"));
		registro.addDefCampo("PORC_CUBRE_GARANTIA", request.getParameter("PorcCubreGarantia"));
		
		//ACTUALIZA EL REGISTRO EN LA BASE DE DATOS
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimClienteGarantia", registro, iTipoOperacion);

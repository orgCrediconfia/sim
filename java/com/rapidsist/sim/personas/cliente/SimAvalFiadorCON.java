 ...
 * modificación y consulta) del aval o fiador. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimAvalFiadorCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimAvalFiador", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaCon.jsp";
		}
			...
			if (request.getParameter("Filtro").equals("Alta")){
				...
				registroControl.sPagina = "/Aplicaciones/Sim/Personas/fSimAvaFiaReg.jsp";
			...
			parametros.addDefCampo("ID_PERSONA",request.getParameter("IdPersona"));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimAvalFiador", parametros));
			registroControl.respuesta.addDefCampo("registroExConyuge", catalogoSL.getRegistro("SimAvalFiadorExConyuge", parametros));	
			registroControl.respuesta.addDefCampo("ListaTelefono", catalogoSL.getRegistros("SimAvalFiadorTelefono", parametros));
			registroControl.respuesta.addDefCampo("ListaTelefonoExConyuge", catalogoSL.getRegistros("SimAvalFiadorExConyugeTelefono", parametros));
			registroControl.respuesta.addDefCampo("ListaDireccion", catalogoSL.getRegistros("SimAvalFiadorDireccion", parametros));
			registroControl.respuesta.addDefCampo("ListaDireccionExConyuge", catalogoSL.getRegistros("SimAvalFiadorExConyugeDireccion", parametros));
			registroControl.respuesta.addDefCampo("ListaEscolaridad", catalogoSL.getRegistros("SimCatalogoEscolaridad", parametros));
			registroControl.respuesta.addDefCampo("ListaIdentificacionOficial", catalogoSL.getRegistros("SimCatalogoIdentificacionOficial", parametros));
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (request.getParameter("EstadoCivil").equals("Casado") || request.getParameter("EstadoCivil").equals("Divorciado")){
			if(request.getParameter("IdPersona") == ""){
				...
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimAvalFiador", registro, iTipoOperacion);
			}
			else if(request.getParameter("IdPersona") != ""  && request.getParameter("IdExConyuge") == ""){
				
				registro.addDefCampo("MODIFICACION_CONYUGE","NO");
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimAvalFiador", registro, iTipoOperacion);
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimAvalFiadorExConyuge", registro, 1);
			}else if(request.getParameter("IdPersona") != "" && request.getParameter("IdExConyuge") != ""){
		...
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimAvalFiador&OperacionCatalogo=CR&IdPersona="+sIdPersona;

...
/**
 * Administra los accesos a la base de datos para el aval o fiador.
 */
 
public class SimAvalFiadorDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {

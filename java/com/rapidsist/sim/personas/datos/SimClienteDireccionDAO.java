...
public class SimClienteDireccionDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			"	ID_TIPO_DOMICILIO, \n"+
			"       DECODE(DOMICILIO_FISCAL,'V','Domicilio Fiscal') DOMICILIO_FISCAL \n" +

...
/**
 * Administra los teléfonos de las referencias de los clientes.
 */
 
public class SimReferenciaTelefonoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			" AND T.IDENTIFICADOR = '" + (String)parametros.getDefCampo("ID_REFERENCIA") + "' \n"+
			" AND T.CVE_TIPO_IDENTIFICADOR = 'REFERENCIA' \n"+
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		...
		sSql = " UPDATE RS_GRAL_TELEFONO SET "+
			   ...
			   " AND CVE_TIPO_IDENTIFICADOR 	='REFERENCIA'\n";

...
public class SimNegocioTelefonoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			" AND T.IDENTIFICADOR = '" + (String)parametros.getDefCampo("ID_NEGOCIO") + "' \n"+

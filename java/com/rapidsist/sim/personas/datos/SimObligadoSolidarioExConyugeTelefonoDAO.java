...
public class SimObligadoSolidarioExConyugeTelefonoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			" AND T.CVE_TIPO_IDENTIFICADOR = 'OBLIGADO' \n"+
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		...
		sSql =  " UPDATE RS_GRAL_TELEFONO SET "+
			...
			" AND CVE_TIPO_IDENTIFICADOR 	='OBLIGADO' \n";

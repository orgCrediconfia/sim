...
/**
 * Administra los accesos a la base de datos para el los obligados solidario.
 */
 
public class SimObligadoSolidarioDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			"AND TP.CVE_TIPO_PERSONA = 'OBLIGADO' \n"+

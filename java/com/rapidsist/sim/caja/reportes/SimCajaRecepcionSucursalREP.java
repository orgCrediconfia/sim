...
public class SimCajaRecepcionSucursalREP implements ReporteControlIN {
	...
	public Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		String sSql =   "SELECT \n"+
						...
						"T.ID_CAJA, \n"+
						"T.FUENTE_DESTINO, \n"+
						"B.NOM_SUCURSAL NOM_SUCURSAL_FUENTE \n"+
						...
						"AND T.CVE_MOVIMIENTO_CAJA = 'RECSUC' \n"+
						...
						"AND B.ID_SUCURSAL = T.FUENTE_DESTINO \n";
		...
		parametros.put("NomReporte", "/Reportes/Sim/caja/SimCajaRecepcionSucursal.jasper");

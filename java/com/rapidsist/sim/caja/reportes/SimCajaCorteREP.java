...
public class SimCajaCorteREP implements ReporteControlIN {
	...
	public Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		parametros.put("NomReporte", "/Reportes/Sim/caja/SimCajaCorte.jasper");
		parametros.put("Subreporte1", contextoServlet.getRealPath("/Reportes/Sim/caja/SimCajaCorteInicial.jasper"));
		parametros.put("Subreporte2", contextoServlet.getRealPath("/Reportes/Sim/caja/SimCajaCorteFinal.jasper"));

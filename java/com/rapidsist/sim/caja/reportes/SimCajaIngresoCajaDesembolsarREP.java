...
public class SimCajaIngresoCajaDesembolsarREP implements ReporteControlIN {
	...
	public Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		String sSql =   "SELECT \n"+
						...
						"T.USUARIO_ENTREGA,  \n"+
						"I.NOM_COMPLETO INTEGRANTE_ENTREGA, \n"+ 
						...
						"AND I.ID_PERSONA (+)= T.USUARIO_ENTREGA \n"+
		...
		parametros.put("NomReporte", "/Reportes/Sim/caja/SimCajaIngresoCajaDesembolsar.jasper");

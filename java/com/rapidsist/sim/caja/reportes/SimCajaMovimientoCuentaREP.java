...
public class SimCajaMovimientoCuentaREP implements ReporteControlIN {
	...
	public Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		String sSql =   "SELECT \n"+
						...
						"AND T.CVE_MOVIMIENTO_CAJA = '" + request.getParameter("CveMovimientoCaja")+"' \n"+ 
		...
		System.out.println("que jais*****************+"+sSql);
		...
		parametros.put("NomReporte", "/Reportes/Sim/caja/SimCajaMovimientoCuenta.jasper");

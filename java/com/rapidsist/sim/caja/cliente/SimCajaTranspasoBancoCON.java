 ...
 */
public class SimCajaTranspasoBancoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){	
			...
			if (request.getParameter("CveBanco") != "" && !request.getParameter("CveBanco").equals("null")){	
				parametros.addDefCampo("FUENTE_DESTINO", request.getParameter("CveBanco"));
			}
			if (request.getParameter("Monto") != "" && !request.getParameter("Monto").equals("")){	
				parametros.addDefCampo("MONTO", request.getParameter("Monto"));
			}
			
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimCajaTranspasoBanco", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaTraBanCon.jsp?IdCaja="+request.getParameter("IdCaja")+"&IdMovimientoOperacion=null";
		}	
		if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Inicio")){
				registroControl.respuesta.addDefCampo("ListaBanco", catalogoSL.getRegistros("SimCatalogoBanco", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaTraBanCon.jsp?IdCaja="+request.getParameter("IdCaja");
			}else if (request.getParameter("Filtro").equals("Alta")){
				registroControl.respuesta.addDefCampo("ListaBanco", catalogoSL.getRegistros("SimCatalogoBanco", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaTraBanReg.jsp?IdCaja="+request.getParameter("IdCaja");
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("USUARIO_RECIBE", request.getParameter("UsuarioRecibe"));
		registro.addDefCampo("FUENTE_DESTINO", request.getParameter("CveBanco"));
		...
		registro.addDefCampo("CVE_MOVIMIENTO_CAJA", "TRABAN");
		
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimCajaTranspasoBanco", registro, iTipoOperacion);
		sIdMovimientoOperacion = (String) registroControl.resultadoCatalogo.Resultado.getDefCampo("ID_MOVIMIENTO_OPERACION");
		
		
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimCajaTranspasoBanco&OperacionCatalogo=IN&Filtro=Inicio&IdCaja="+request.getParameter("IdCaja")+"&IdMovimientoOperacion="+sIdMovimientoOperacion;
		return registroControl;
	}
}
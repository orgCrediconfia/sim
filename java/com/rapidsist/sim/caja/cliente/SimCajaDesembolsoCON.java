 ...
 */
public class SimCajaDesembolsoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			if (!request.getParameter("IdPrestamo").equals("")){
				
				registroControl.respuesta.addDefCampo("ListaMonto", catalogoSL.getRegistros("SimPrestamoMontoCliente", parametros));
			}
			
			if (!request.getParameter("IdGrupo").equals("")){
			
				parametros.addDefCampo("CONSULTA","TODOS");
				registroControl.respuesta.addDefCampo("ListaMonto", catalogoSL.getRegistros("SimCajaMontoClienteGrupo", parametros));
				parametros.addDefCampo("CONSULTA","SUMA");
				registroControl.respuesta.addDefCampo("Total", catalogoSL.getRegistros("SimCajaMontoClienteGrupo", parametros));
			}
			
			registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaDes.jsp?IdCaja="+request.getParameter("IdCaja");
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (!request.getParameter("IdPrestamo").equals("")){
			...
			monto = catalogoSL.getRegistro("SimPrestamoMontoCliente", registro);
		}
		
		if (!request.getParameter("IdGrupo").equals("")){
			
			monto = catalogoSL.getRegistro("SimCajaMontoClienteGrupo", registro);
		}
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimCajaDesembolso", registro, iTipoOperacion);
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimCajaMovimiento&OperacionCatalogo=IN&Filtro=Alta&IdCaja="+request.getParameter("IdCaja");
		return registroControl;
	}
}
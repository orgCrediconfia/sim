 ...
 */
public class SimCajaPagoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			if (request.getParameter("Filtro").equals("Inicio")){
				registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaPago.jsp";
			}else if (request.getParameter("Filtro").equals("Alta")){
				if (request.getParameter("IdGrupo").equals("")){
					
					registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaPagoInd.jsp";
				}else if (request.getParameter("IdPrestamo").equals("")){
					
					registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaPagoGpo.jsp";
				} 
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("IMP_NETO", request.getParameter("Importe"));
		registro.addDefCampo("FECHA_MOVIMIENTO", request.getParameter("FechaMovimiento"));
		
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimCajaPago", registro, iTipoOperacion);
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimCajaPago&OperacionCatalogo=IN&Filtro=Inicio";
		return registroControl;
	}
}
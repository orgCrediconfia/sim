 ...
 */
public class SimCajaMovimientoCuentaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){	
			...
			if (request.getParameter("CvePrestamo") != "" && !request.getParameter("CvePrestamo").equals("")){	
			...
			if (request.getParameter("NomCompleto") != "" && !request.getParameter("NomCompleto").equals("")){	
				parametros.addDefCampo("NOMBRE", request.getParameter("NomCompleto"));
			}
			
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimCajaMovimientoCuenta", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaMovtoCtaCon.jsp?IdCaja="+request.getParameter("IdCaja")+"&NomMovimientoCaja="+request.getParameter("NomMovimientoCaja")+"&IdMovimientoOperacion=null";
		}	
		if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Inicio")){
				...
				if (request.getParameter("AplicaA").equals("GRUPO")){
					...
					registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaMovtoCtaGpo.jsp?IdCaja="+request.getParameter("IdCaja");
				}else if (request.getParameter("AplicaA").equals("INDIVIDUAL")){
					registroControl.sPagina = "/Aplicaciones/Sim/Caja/fSimCajaMovtoCtaInd.jsp?IdCaja="+request.getParameter("IdCaja");
				}
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("CVE_MOVIMIENTO_CAJA", request.getParameter("CveMovimientoCaja"));

...
public class SimCatalogoSubSectorDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public ResultadoCatalogo alta(Registro registro) throws SQLException{
		...
		sSql =  "INSERT INTO SIM_CAT_SUB_SECTOR ( \n"+
				"CVE_GPO_EMPRESA, \n" +
				"CVE_EMPRESA, \n" +
				"CVE_SECTOR, \n" +
				"CVE_SUB_SECTOR, \n" +
			...
			"'" + (String)registro.getDefCampo("NOM_SUB_SECTOR") + "') \n" ;
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		ResultadoCatalogo resultadoCatalogo = new ResultadoCatalogo();
		sSql = " UPDATE SIM_CAT_SUB_SECTOR SET "+
			   " NOM_SUB_SECTOR	 	 = '" + (String)registro.getDefCampo("NOM_SUB_SECTOR")  + "' \n" +
	...
	public ResultadoCatalogo baja(Registro registro) throws SQLException{
		ResultadoCatalogo resultadoCatalogo = new ResultadoCatalogo();
		//BORRA LA FUNCION
		sSql =   " DELETE FROM SIM_CAT_SUB_SECTOR " +
			 " WHERE CVE_SECTOR    	 = '" + (String)registro.getDefCampo("CVE_SECTOR") + "' \n" +
			 " AND CVE_SUB_SECTOR   	 = '" + (String)registro.getDefCampo("CVE_SUB_SECTOR") + "' \n"+
			 " AND CVE_EMPRESA   	 = '" + (String)registro.getDefCampo("CVE_EMPRESA") + "' \n"+
			 " AND CVE_GPO_EMPRESA = '" + (String)registro.getDefCampo("CVE_GPO_EMPRESA") + "' \n";

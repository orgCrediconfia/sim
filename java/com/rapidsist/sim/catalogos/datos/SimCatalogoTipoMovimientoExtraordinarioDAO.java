...
public class SimCatalogoTipoMovimientoExtraordinarioDAO extends Conexion2 implements OperacionConsultaTabla, OperacionAlta,  OperacionConsultaRegistro, OperacionModificacion, OperacionBaja  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql = "SELECT \n"+
				...
				" M.NOM_TIPO_MOVIMIENTO \n"+
			" FROM SIM_CAT_TIPO_MOVIMIENTO_EXTRA M \n"+
		...
		sSql = sSql + " ORDER BY NOM_TIPO_MOVIMIENTO \n";	
	...
	public Registro getRegistro(Registro parametros) throws SQLException{
		sSql = "SELECT \n"+
				...
				" ID_TIPO_MOVIMIENTO \n"+
			" FROM SIM_CAT_MOVIMIENTO_EXTRA \n"+
			" WHERE CVE_GPO_EMPRESA ='" + (String)parametros.getDefCampo("CVE_GPO_EMPRESA") + "' \n"+
			" AND CVE_EMPRESA ='" + (String)parametros.getDefCampo("CVE_EMPRESA") + "' \n"+
			" AND ID_MOVIMIENTO_EXTRA = '" + (String)parametros.getDefCampo("ID_MOVIMIENTO_EXTRA") + "' \n";

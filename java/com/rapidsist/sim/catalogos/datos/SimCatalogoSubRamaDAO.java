...
public class SimCatalogoSubRamaDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql = sSql + " ORDER BY CVE_SUB_RAMA \n";
	...
	public ResultadoCatalogo alta(Registro registro) throws SQLException{
		...
		sSql =  "INSERT INTO SIM_CAT_SUB_RAMA ( \n"+
				"CVE_GPO_EMPRESA, \n" +
				"CVE_EMPRESA, \n" +
				"CVE_SECTOR, \n" +
				"CVE_SUB_SECTOR, \n" +
			...
			"'" + (String)registro.getDefCampo("NOM_SUB_RAMA") + "') \n" ;
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		ResultadoCatalogo resultadoCatalogo = new ResultadoCatalogo();
		sSql = " UPDATE SIM_CAT_SUB_RAMA SET "+
			   " NOM_SUB_RAMA	 	 = '" + (String)registro.getDefCampo("NOM_SUB_RAMA")  + "' \n" +
	...
	public ResultadoCatalogo baja(Registro registro) throws SQLException{
		ResultadoCatalogo resultadoCatalogo = new ResultadoCatalogo();
		//BORRA LA FUNCION
		sSql =   " DELETE FROM SIM_CAT_SUB_RAMA " +
			 " WHERE CVE_SECTOR    	 = '" + (String)registro.getDefCampo("CVE_SECTOR") + "' \n" +
			   " AND CVE_SUB_SECTOR   	 = '" + (String)registro.getDefCampo("CVE_SUB_SECTOR") + "' \n"+
			   " AND CVE_RAMA   	 = '" + (String)registro.getDefCampo("CVE_RAMA") + "' \n"+
			   " AND CVE_SUB_RAMA   	 = '" + (String)registro.getDefCampo("CVE_SUB_RAMA") + "' \n"+

...
/**
 * Administra los telefonos de las sucursales.
 */
 
public class SimSucursalTelefonoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			" AND T.IDENTIFICADOR = '" + (String)parametros.getDefCampo("ID_SUCURSAL") + "' \n"+
			" AND T.CVE_TIPO_IDENTIFICADOR = 'SUCURSAL' \n"+
	...
	public ResultadoCatalogo modificacion(Registro registro) throws SQLException{
		...
		sSql = " UPDATE RS_GRAL_TELEFONO SET "+
			   ...
			   " AND CVE_TIPO_IDENTIFICADOR ='SUCURSAL'\n";

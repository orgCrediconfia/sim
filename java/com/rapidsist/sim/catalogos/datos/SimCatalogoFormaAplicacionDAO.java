...
/**
 * Administra los accesos a la base de datos para el catálogo de forma de aplicación.
 */
 
public class SimCatalogoFormaAplicacionDAO extends Conexion2 implements OperacionConsultaTabla, OperacionAlta,  OperacionConsultaRegistro, OperacionModificacion, OperacionBaja  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql = "SELECT \n"+
				...
				" CVE_EMPRESA, \n"+
				" ID_FORMA_APLICACION, \n"+
				" NOM_FORMA_APLICACION \n"+
				" FROM SIM_CAT_FORMA_APLICACION \n"+
		
				" WHERE CVE_GPO_EMPRESA ='" + (String)parametros.getDefCampo("CVE_GPO_EMPRESA") + "' \n"+
				" AND CVE_EMPRESA ='" + (String)parametros.getDefCampo("CVE_EMPRESA") + "' \n";
				
		sSql = sSql + " ORDER BY NOM_FORMA_APLICACION \n";

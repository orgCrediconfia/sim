 ...
 */
public class SimCatalogoClaseSinonimoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			parametros.addDefCampo("CVE_SINONIMO",request.getParameter("CveSinonimo"));
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimCatalogoClaseSinonimo", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/CatalogosGenerales/fSimClaSinReg.jsp";
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("CVE_SINONIMO",request.getParameter("CveSinonimo"));
		registro.addDefCampo("NOM_SINONIMO",request.getParameter("NomSinonimo"));
		
		//ACTUALIZA EL REGISTRO EN LA BASE DE DATOS		
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimCatalogoClaseSinonimo", registro, iTipoOperacion);
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimCatalogoClase&OperacionCatalogo=CR&CveSector="+request.getParameter("CveSector")+"&CveSubSector="+request.getParameter("CveSubSector")+"&CveRama="+request.getParameter("CveRama")+"&CveSubRama="+request.getParameter("CveSubRama")+"&CveClase="+request.getParameter("CveClase");

 ...
 */
public class SimCatalogoSubRamaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimCatalogoSubRama", parametros));
			registroControl.respuesta.addDefCampo("ListaClase", catalogoSL.getRegistros("SimCatalogoClase", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/CatalogosGenerales/fSimSubRamReg.jsp";
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("NOM_SUB_RAMA",request.getParameter("NomSubRama"));
		
		//ACTUALIZA EL REGISTRO EN LA BASE DE DATOS		
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimCatalogoSubRama", registro, iTipoOperacion);
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimCatalogoRama&OperacionCatalogo=CR&CveSector="+request.getParameter("CveSector")+"&CveSubSector="+request.getParameter("CveSubSector")+"&CveRama="+request.getParameter("CveRama");

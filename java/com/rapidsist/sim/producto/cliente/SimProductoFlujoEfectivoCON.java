 ...
 */
public class SimProductoFlujoEfectivoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimProductoFlujoEfectivo", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Producto/fSimProFluEfe.jsp";
		}
		
		else if (iTipoOperacion == CON_INICIALIZACION){
				registroControl.sPagina = "/Aplicaciones/Sim/Producto/fSimProFluEfe.jsp?IdProducto="+request.getParameter("IdProducto");		
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_ARCHIVO_FLUJO",request.getParameter("IdArchivoFlujo"));
		registro.addDefCampo("NOM_ARCHIVO",request.getParameter("NomArchivo"));
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimProductoFlujoEfectivo", registro, iTipoOperacion);

 ...
 * modificación y consulta) del los accesorios por producto-ciclo. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimProductoCicloAccesorioCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("ListaAccesorio", catalogoSL.getRegistros("SimProductoCicloAccesorio", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Producto/fSimProCicAcc.jsp";
		}

...
public class SimReporteEstadoCuentaIndividualREP implements ReporteControlIN {
	...
	public  Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		System.out.println("Estado de cuenta individual"+sSql);
		...
		parametros.put("Subreporte2", contextoServlet.getRealPath("/Reportes/Sim/reportes/SimReporteEstadoCuentaResumenIndividual.jasper"));

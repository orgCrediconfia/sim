...
public class SimReporteSeguimientoREP implements ReporteControlIN {
	...
	public  Map getParametros(Registro parametrosCatalogo, HttpServletRequest request, CatalogoSL catalogoSL, Context contextoServidor, ServletContext contextoServlet)  throws Exception{
		...
		"IFNULL(SALDO_PROX_PAGO_INTERES,0) + IFNULL(SALDO_PROX_PAGO_CAPITAL,0) + IFNULL(SALDO_PROX_PAGO_SEGURO,0) + IFNULL(SALDO_PROX_PAGO_RECARGO,0) SALDO_PROX_PAGO_TOTAL, \n"+
		"SALDO_INTERES, \n"+
		"SALDO_CAPITAL, \n"+
		"SALDO_SEGURO, \n"+
		"SALDO_RECARGO, \n"+

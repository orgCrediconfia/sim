 ...
 */
public class SimReporteCapitalVencidoCON implements CatalogoControlConsultaIN {
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			parametros.addDefCampo("CVE_PRESTAMO_GRUPO",request.getParameter("CvePrestamoGpo"));
			
			
			//VERIFICA SI SE ENVIO EL PARAMETRO NOMBRE
			if (request.getParameter("CvePrestamoGpo") != null && !request.getParameter("CvePrestamoGpo").equals("")){
				parametros.addDefCampo("CVE_PRESTAMO_GRUPO", request.getParameter("CvePrestamoGpo"));
			}
			
			registroControl.sPagina = "/Aplicaciones/Sim/Reportes/fSimReporteCapitalVencidoCon.jsp";
		}

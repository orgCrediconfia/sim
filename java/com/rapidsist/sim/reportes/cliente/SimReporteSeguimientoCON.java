	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Inicio")){
				...
				parametros.addDefCampo("ID_SUCURSAL","");
				registroControl.respuesta.addDefCampo("ListaAsesor", catalogoSL.getRegistros("SimUsuarioAsesorSucursal", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Reportes/fSimReporteSegCon.jsp?IdRegional="+request.getParameter("IdRegional");	
				...
				registroControl.respuesta.addDefCampo("ListaAsesor", catalogoSL.getRegistros("SimUsuarioAsesorSucursal", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Reportes/fSimReporteSegCon.jsp?IdRegional="+request.getParameter("IdRegional")+"&IdSucursal="+request.getParameter("IdSucursal");
			}
		}

 ...
 */
public class SimEstadoCuentaResumenGrupoCON implements CatalogoControlConsultaIN {
	 ...
	 * especificadas en la clase {@link com.rapidsist.portal.cliente.CataSimEstadoCuentaResumenGrupoCONlogoControl CatalogoControl}
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.sPagina = "/Aplicaciones/Sim/Reportes/fSimEstadoCuentaResumenGrupoCon.jsp";
		}

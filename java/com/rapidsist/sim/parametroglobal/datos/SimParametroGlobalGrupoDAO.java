...
/**
 * Administra los accesos a la base de datos para los parámetros globales del grupo.
 */
 
public class SimParametroGlobalGrupoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public Registro getRegistro(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			"	MAXIMO_RIESGO \n"+
			"FROM SIM_PARAMETRO_GLOBAL_GRUPO \n"+
			"WHERE NUM_INTEGRANTE		='" + (String)parametros.getDefCampo("NUM_INTEGRANTE") + "' \n" +
			"ORDER BY NUM_INTEGRANTE \n";
		ejecutaSql();

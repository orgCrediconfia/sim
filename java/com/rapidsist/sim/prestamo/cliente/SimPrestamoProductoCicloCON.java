 ...
 * modificación y consulta) del producto ciclo asigandos al crédito individual. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimPrestamoProductoCicloCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("ID_CLIENTE", request.getParameter("IdPersona"));
		...
		registro.addDefCampo("APLICA_A", request.getParameter("AplicaA") != null ? request.getParameter("AplicaA") : "" );
		...
		registro.addDefCampo("MONTO_MINIMO", request.getParameter("MontoMinimo") != null ? request.getParameter("MontoMinimo") : "");

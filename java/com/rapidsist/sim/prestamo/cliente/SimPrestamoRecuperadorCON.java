 ...
 * modificación y consulta) de los recuperadores de los créditos. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimPrestamoRecuperadorCON implements CatalogoControlConsultaIN {
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaRecuperador", catalogoSL.getRegistros("SimPrestamoRecuperador", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimPreRec.jsp";
		}

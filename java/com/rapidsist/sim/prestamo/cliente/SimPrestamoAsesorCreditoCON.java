 ...
 * modificación y consulta) de los asesores de un préstamo. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimPrestamoAsesorCreditoCON implements CatalogoControlConsultaIN {
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaAsesorCredito", catalogoSL.getRegistros("SimPrestamoAsesorCredito", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimPreAseCred.jsp";
		}

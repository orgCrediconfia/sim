 ...
 * modificación y consulta) para asignar el producto-ciclo a un préstamo. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimAsignaProductoCicloCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			if (request.getParameter("IdProducto") != "" && !request.getParameter("IdProducto").equals("")){
				parametros.addDefCampo("IDENTIFICADOR_PRODUCTO", request.getParameter("IdProducto"));	
			}
			...
			registroControl.respuesta.addDefCampo("ListaBusqueda", catalogoSL.getRegistros("SimAsignaProductoCiclo", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimAsiProCicCon.jsp";
		}
			...
			registroControl.respuesta.addDefCampo("ListaAccesorio", catalogoSL.getRegistros("SimProductoAccesorio", parametros));
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registro.addDefCampo("CVE_METODO",request.getParameter("MetodoCalculoProducto"));
		...
		if (iTipoOperacion == 1){
			...
			String sTodasSucursales = (String) registroControl.resultadoCatalogo.Resultado.getDefCampo("TODAS_SUCURSALES");
			if (sTodasSucursales.equals("V")){
				String sIdProducto = (String) registroControl.resultadoCatalogo.Resultado.getDefCampo("ID_PRODUCTO");
		...
		registroControl.sPagina = "/ProcesaCatalogo?Funcion=SimProducto&OperacionCatalogo=IN&Filtro=Inicio";
		return registroControl;
	}
}

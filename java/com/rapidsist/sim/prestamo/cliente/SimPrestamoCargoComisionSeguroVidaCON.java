 ...
 * modificación y consulta) del seguro de vida. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimPrestamoCargoComisionSeguroVidaCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_TABLA){
			...
			registroControl.respuesta.addDefCampo("ListaBeneficiario", catalogoSL.getRegistros("SimPrestamoCargoComisionSeguroVida", parametros));
			registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimPreCarComSegVid.jsp?IdPrestamo="+request.getParameter("IdPrestamo")+"&IdProducto="+request.getParameter("IdProducto")+"&IdCargoComision="+request.getParameter("IdCargoComision");
		}

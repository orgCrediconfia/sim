 ...
 */
public class SimPrestamoMontoClienteCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (sMontos != null) {
			...
			for (int iNumParametro = 0; iNumParametro < sMontos.length; iNumParametro++) {
				...
				registroControl.resultadoCatalogo = catalogoSL.modificacion("SimPrestamoMontoCliente", registro, 1);//MODIFICACION	
			}
		}

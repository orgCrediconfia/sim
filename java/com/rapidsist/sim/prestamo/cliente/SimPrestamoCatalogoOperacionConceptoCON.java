 ...
 */
public class SimPrestamoCatalogoOperacionConceptoCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimPrestamoCatalogoOperacionConcepto", parametros));
			registroControl.respuesta.addDefCampo("ListaConcepto", catalogoSL.getRegistros("SimPrestamoCatalogoConcepto", parametros));
			//VERIFICA SI SOLO CONSULTA LOS DATOS DEL REGISTRO
			registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimPreCatOpeConReg.jsp";
		}
		else if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Alta")){
				parametros.addDefCampo("CVE_OPERACION",request.getParameter("CveOperacion"));
				registroControl.respuesta.addDefCampo("ListaConcepto", catalogoSL.getRegistros("SimPrestamoCatalogoConcepto", parametros));
				registroControl.sPagina = "/Aplicaciones/Sim/Prestamo/fSimPreCatOpeConReg.jsp?CveOperacion"+request.getParameter("CveOperacion");
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimPrestamoCatalogoOperacionConcepto", registro, iTipoOperacion);

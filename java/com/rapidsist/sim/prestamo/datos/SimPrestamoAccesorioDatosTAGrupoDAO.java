...
public class SimPrestamoAccesorioDatosTAGrupoDAO extends Conexion2 implements OperacionConsultaTabla {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  " SELECT \n"+
			...
			" AND CC.ID_PRESTAMO_GRUPO ='" + (String)parametros.getDefCampo("ID_PRESTAMO_GRUPO") + "' \n"+

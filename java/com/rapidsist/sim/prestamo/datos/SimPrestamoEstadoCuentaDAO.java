...
public class SimPrestamoEstadoCuentaDAO extends Conexion2 implements OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
			...
			sSql =  "SELECT \n"+
					...
					"ORDER BY RI.F_OPERACION, VI.FECHA_AMORTIZACION, RI.ID_MOVIMIENTO, RI.NUM_PAGO_AMORTIZACION, ABS(NVL(ROUND(RI.IMP_PAGO,2),0)) DESC, NVL(ROUND(RI.IMP_CONCEPTO,2),0) \n";

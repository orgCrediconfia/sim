...
public class SimPrestamoAccesorioOrdenGrupoDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro, OperacionAlta, OperacionModificacion, OperacionBaja {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  " SELECT DISTINCT \n"+
			...
			" AND PA.ID_GRUPO ='" + (String)parametros.getDefCampo("ID_GRUPO") + "' \n"+
			" AND P.CVE_GPO_EMPRESA = PA.CVE_GPO_EMPRESA \n" +
			" AND P.CVE_EMPRESA = PA.CVE_EMPRESA \n"+
			" AND P.ID_PERSONA = PA.ID_CLIENTE \n";
		
		sSql = sSql + " ORDER BY PA.ID_CLIENTE \n";

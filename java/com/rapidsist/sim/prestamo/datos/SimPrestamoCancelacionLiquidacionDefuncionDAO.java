...
public class SimPrestamoCancelacionLiquidacionDefuncionDAO extends Conexion2 implements OperacionConsultaTabla, OperacionAlta {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		//Consulta todos los créditos liquidados por defunción.
		sSql = "SELECT \n"+
				"V.CVE_GPO_EMPRESA, \n"+
				"V.CVE_EMPRESA, \n"+
				"V.ID_PRESTAMO, \n"+
	...
	public ResultadoCatalogo alta(Registro registro) throws SQLException{
		...
		if(registro.getDefCampo("APLICA_A").equals("INDIVIDUAL")){
			...
			CallableStatement sto1 = conn.prepareCall("begin dbms_output.put_line(PKG_CREDITO.fCancelaDefuncion(?,?,?,?,?)); end;");

	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		if (parametros.getDefCampo("CONSULTA").equals("REGISTRO")){	
			...
			sSql =  "SELECT \n"+
					...
					"GROUP BY VR.CVE_GPO_EMPRESA, VR.CVE_EMPRESA, VR.ID_PRESTAMO, VR.F_APLICACION, VR.NUM_PAGO_AMORTIZACION, VR.F_OPERACION, VR.ID_MOVIMIENTO, VG.FECHA_AMORTIZACION, VR.DESC_MOVIMIENTO \n"+ 
					"ORDER BY VR.F_OPERACION, VG.FECHA_AMORTIZACION, VR.ID_MOVIMIENTO, VR.NUM_PAGO_AMORTIZACION, NVL(ROUND(VR.IMP_PAGO,2),0) DESC, SUM(NVL(ROUND(VR.IMP_CONCEPTO,2),0)) \n";

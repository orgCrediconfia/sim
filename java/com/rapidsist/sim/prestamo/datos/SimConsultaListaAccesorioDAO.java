...
/**
 * Administra los accesos a la base de datos para la consulta de los accesorios de un préstamo.
 */
 
public class SimConsultaListaAccesorioDAO extends Conexion2 implements OperacionConsultaTabla, OperacionConsultaRegistro {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  " SELECT DISTINCT \n"+
                    	"A.ID_ACCESORIO, \n"+
                    	"C.NOM_ACCESORIO  \n"+
			"FROM    SIM_TABLA_AMORT_ACCESORIO A, \n"+
			"        SIM_CAT_ACCESORIO C \n"+
			...
			"AND     A.ID_PRESTAMO = '" + (String)parametros.getDefCampo("ID_PRESTAMO") + "' \n" +
			"AND     C.CVE_GPO_EMPRESA = A.CVE_GPO_EMPRESA \n"+
			"AND     C.CVE_EMPRESA = A.CVE_EMPRESA \n"+
			"AND     C.ID_ACCESORIO = A.ID_ACCESORIO \n"+
			"ORDER BY A.ID_ACCESORIO \n";

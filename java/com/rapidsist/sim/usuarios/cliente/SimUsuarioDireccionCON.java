 ...
 * modificación y consulta) de las direcciones de los usuarios. Esta clase es llamada por
 * el servlet {@link CatalogoS CatalogoS}.
 */
public class SimUsuarioDireccionCON implements CatalogoControlConsultaIN, CatalogoControlActualizaIN{
	...
	public RegistroControl consulta(Registro parametros, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		if (iTipoOperacion == CON_CONSULTA_REGISTRO){
			...
			registroControl.respuesta.addDefCampo("registro", catalogoSL.getRegistro("SimUsuarioDireccion", parametros));
			//VERIFICA SI SOLO CONSULTA LOS DATOS DEL REGISTRO
			registroControl.sPagina = "/Aplicaciones/Sim/Usuarios/fSimUsuDir.jsp?IdPersona="+request.getParameter("IdPersona")+"&CveUsuario="+request.getParameter("CveUsuario");
		}
		else if (iTipoOperacion == CON_INICIALIZACION){
			if (request.getParameter("Filtro").equals("Alta")){
				registroControl.sPagina = "/Aplicaciones/Sim/Usuarios/fSimUsuDir.jsp";
			}else if (request.getParameter("Filtro").equals("Inicio")){
				registroControl.sPagina = "/Aplicaciones/Sim/Clientes/fSimCliCon.jsp";
			}
		}
	...
	public RegistroControl actualiza(Registro registro, HttpServletRequest request, HttpServletResponse response, ServletConfig config, CatalogoSL catalogoSL, Context contexto, int iTipoOperacion)throws RemoteException, Exception{
		...
		registroControl.resultadoCatalogo = catalogoSL.modificacion("SimUsuarioDireccion", registro, iTipoOperacion);

...
/**
 * Administra los accesos a la base de datos para la direcciones de los usuarios.
 */
 
public class SimUsuarioDireccionDAO extends Conexion2 implements OperacionAlta, OperacionBaja, OperacionModificacion, OperacionConsultaRegistro, OperacionConsultaTabla  {
	...
	public LinkedList getRegistros(Registro parametros) throws SQLException{
		...
		sSql =  "SELECT \n"+
			...
			"AND CVE_TIPO_IDENTIFICADOR = 'USUARIO' \n";

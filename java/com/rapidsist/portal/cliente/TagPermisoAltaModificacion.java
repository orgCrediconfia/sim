 ...
 * tiene el permiso de alta o modificación de la función especificada en la página.
 */
public class TagPermisoAltaModificacion extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		if (permiso.bAlta || permiso.bModificacion){

 ...
 * de consulta de información a la base de datos para las clases CON. Las operacion soportadas
 * por este método son: Inicialización de datos (CON_INICIALIZACION), consulta de un
...
public interface CatalogoControlConsultaIN extends CatalogoControl{
	 ...
	 * @param parametros Parámetros por default para la clase CON.
	 ...
	 * @return Resultado de la consulta de datos y la página a donde se redirecciona el control.

...
public class PortalDefault implements Serializable{
	...
	/**
	 * Url de pie de página.
	 */
	public String sUrlPiePagina;
	
	/**
	 * Url del contenido de inicio.
	 */
	public String sUrlContenidoInicio;
	
	/**
	 * Url del Contenido del fin.
	 */
	 ...
	 * Url de estilo.
	 */
	public String sUrlEstilo;
	
	/**
	 * Url de menú de aplicación.
	 */
	 ...
	 * Clave del perfil
	 */
	public String sCvePerfil;
	
	/**
	 * Url del dierectorio default.
	 */

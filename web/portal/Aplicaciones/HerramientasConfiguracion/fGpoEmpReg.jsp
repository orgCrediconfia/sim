...
<Portal:Pagina funcion="HerramientasConfiguracionGrupoEmpresa" precarga="HerramientasConfiguracionEmpresa HerramientasConfiguracionPortal HerramientasConfiguracionGrupoEmpresaAplicacion">
	<Portal:PaginaNombre titulo="Grupo de Empresas" subtitulo="Modificaci&oacuten de datos" subtituloalta="Alta de datos"/>
	
	<Portal:Forma tipo='catalogo' funcion='HerramientasConfiguracionGrupoEmpresa'>
	...
	<Portal:TablaLista maestrodetallefuncion="HerramientasConfiguracionEmpresa" tipo="alta" nombre="Empresas" botontipo="url" url='/Aplicaciones/HerramientasConfiguracion/fGpoEmpEmpReg.jsp?OperacionCatalogo=AL&CveGpoEmpresa=${registro.campos["CVE_GPO_EMPRESA"]}'>
		<Portal:TablaListaTitulos>
			<Portal:Columna tipovalor='texto' ancho='100' valor='Clave'/>
			<Portal:Columna tipovalor='texto' ancho='100%' valor='Nombre'/>
		</Portal:TablaListaTitulos>
		<c:forEach var="registro" items="${requestScope.ListaEmpresas}">
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='100' valor='' >
					<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CVE_EMPRESA"]}' funcion='HerramientasConfiguracionEmpresa' operacion='CR' parametros='CveEmpresa=${registro.campos["CVE_EMPRESA"]}&CveGpoEmpresa=${registro.campos["CVE_GPO_EMPRESA"]}'/>
				</Portal:Columna>				
				<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["NOM_EMPRESA"]}'/>
			</Portal:TablaListaRenglon>
		</c:forEach>			
	</Portal:TablaLista>
	...
	<Portal:TablaForma maestrodetallefuncion="HerramientasConfiguracionGrupoEmpresaAplicacion" nombre="Aplicaciones asignadas al grupo de empresas" funcion="HerramientasConfiguracionGrupoEmpresaAplicacion" operacion="BA" parametros='CveGpoEmpresa=${registro.campos["CVE_GPO_EMPRESA"]}'>
		<Portal:TablaListaTitulos>

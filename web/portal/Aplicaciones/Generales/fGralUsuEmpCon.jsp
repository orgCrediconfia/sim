...
<Portal:Pagina funcion="GeneralesUsuarioEmpresa">
	<Portal:PaginaNombre titulo="Usuarios" subtitulo="Consulta de datos"/>
	
	<Portal:Forma tipo='busqueda' funcion='GeneralesUsuarioEmpresa' operacion='CT'>
	...
	<Portal:TablaLista tipo="alta" nombre="Consulta usuarios" botontipo="url" url='/ProcesaCatalogo?Funcion=GeneralesUsuarioEmpresa&OperacionCatalogo=IN&Filtro=Alta&CveGpoEmpresa=${param.CveGpoEmpresa}'>
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='10%' valor=''>
					<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CVE_USUARIO"]}' funcion='GeneralesUsuarioEmpresa' operacion='CR' parametros='CveUsuario=${registro.campos["CVE_USUARIO"]}&CveGpoEmpresa=${registro.campos["CVE_GPO_EMPRESA"]}' parametrosregreso='\'${registro.campos["CVE_USUARIO"]}\', \'${registro.campos["NOM_COMPLETO"]}\'' />
				</Portal:Columna>

...
<Portal:Pagina funcion="GeneralesUsuarioPerfil">
	...
	<Portal:TablaForma nombre="Aplicaciones y perfiles disponibles para asignar al usuario" funcion='GeneralesUsuarioPerfil' operacion='AL' parametros='CveUsuario=${param.CveUsuario}'>

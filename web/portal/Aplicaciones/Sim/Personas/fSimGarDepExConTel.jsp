...
<Portal:Pagina funcion="SimGaranteDepositarioExConyugeTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Cónyuge o Excónyuge del Garante Depositario" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimGaranteDepositarioExConyugeTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}'>

...
<Portal:Pagina funcion="SimAvalFiadorTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Aval o Fiador" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimAvalFiadorTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}'>

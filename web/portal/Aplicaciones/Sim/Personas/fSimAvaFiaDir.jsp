...
<Portal:Pagina funcion="SimAvalFiadorDireccion">
	<Portal:PaginaNombre titulo="Direcci&oacute;n" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>

	<Portal:Forma tipo='catalogo' funcion='SimAvalFiadorDireccion' parametros='IdPersona=${param.IdPersona}&IdDomicilio=${param.IdDomicilio}'>
	
		<Portal:FormaSeparador nombre="Direcci&oacute;n del Aval o Fiador"/>				

...
<Portal:Pagina funcion="SimObligadoSolidario">
	<Portal:PaginaNombre titulo="Obligado Solidario" subtitulo="Consulta de datos"/>
	
	<Portal:Forma tipo='busqueda' funcion='SimObligadoSolidario' operacion='CT' filtro='Todos'>
	...
	<Portal:TablaLista tipo="alta" nombre="Consulta de Obligarios Solidarios" botontipo="url" url='/ProcesaCatalogo?Funcion=SimObligadoSolidario&OperacionCatalogo=IN&Filtro=Alta'>
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='250' valor=''>					
					<Portal:Url tipo='catalogo' nombreliga='${registro.campos["ID_PERSONA"]}' funcion='SimObligadoSolidario' operacion='CR' parametros='IdPersona=${registro.campos["ID_PERSONA"]}' parametrosregreso='\'${registro.campos["ID_PERSONA"]}\', \'${registro.campos["NOM_COMPLETO"]}\''/>
				</Portal:Columna>
	...
	<script>
		function RegresaDatos(IdPersona, NomCompleto){
			...
			padre.document.frmRegistro.IdPersonaObligado.value  = IdPersona;
			padre.document.getElementById('NomCompletoObligado').innerHTML = NomCompleto;

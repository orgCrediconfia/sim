...
<Portal:Pagina funcion="SimObligadoSolidarioExConyugeTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Cónyuge o Excónyuge del Obligado solidario" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimObligadoSolidarioExConyugeTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}'>

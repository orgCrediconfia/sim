...
<Portal:Pagina funcion="SimGaranteDepositarioTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Garante Depositario" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimGaranteDepositarioTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}'>

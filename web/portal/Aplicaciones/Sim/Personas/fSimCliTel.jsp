...
<Portal:Pagina funcion="SimClienteTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Cliente" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimClienteTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}&IdExConyuge=${param.IdExConyuge}'>

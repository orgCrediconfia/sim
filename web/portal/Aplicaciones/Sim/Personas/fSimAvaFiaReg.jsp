...
<Portal:Pagina funcion="SimAvalFiador" precarga="SimAvalFiadorDireccion SimAvalFiadorTelefono SimAvalFiadorExConyugeDireccion SimAvalFiadorExConyugeTelefono">
	<Portal:PaginaNombre titulo="Aval o Fiador" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>

	<Portal:Forma tipo='catalogo' funcion='SimAvalFiador' parametros='IdPersona=${param.IdPersona}&IdExConyuge=${param.IdExConyuge}'>

		<Portal:FormaSeparador nombre="Datos generales del Aval o Fiador"/>
		...
		<Portal:TablaForma maestrodetallefuncion="SimAvalFiadorTelefono" nombre="Teléfonos del Aval o fiador" funcion="SimAvalFiadorTelefono" operacion="BA">
			...
			<c:forEach var="registro" items="${requestScope.ListaTelefono}">
				<Portal:TablaListaRenglon>
					<Portal:Columna tipovalor='texto' ancho='150' valor=''>
						<Portal:Url tipo='catalogo' nombreliga='${registro.campos["TELEFONO"]}' funcion='SimAvalFiadorTelefono' operacion='CR' parametros='IdTelefono=${registro.campos["ID_TELEFONO"]}&IdPersona=${param.IdPersona}'/>
					</Portal:Columna>
					<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["NOM_DESC_TEL"]}'/>
				</Portal:TablaListaRenglon>
			</c:forEach>
			<Portal:FormaBotones>
				<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimAvalFiadorTelefono&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
			</Portal:FormaBotones>		
		</Portal:TablaForma>
		
		<Portal:TablaForma maestrodetallefuncion="SimAvalFiadorDireccion" nombre="Direcciones del Aval o fiador" funcion="SimAvalFiadorDireccion" operacion="BA">
			<Portal:TablaListaTitulos>
			...
			<c:forEach var="registro" items="${requestScope.ListaDireccion}">
				<Portal:TablaListaRenglon>
					<Portal:Columna tipovalor='texto' ancho='200' valor=''>
						<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CALLE"]} ${registro.campos["NUMERO_INT"]}' funcion='SimAvalFiadorDireccion' operacion='CR' parametros='IdDomicilio=${registro.campos["ID_DOMICILIO"]}&IdPersona=${param.IdPersona}'/>
					</Portal:Columna>
			...
			<Portal:FormaBotones>
				<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimAvalFiadorDireccion&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
			</Portal:FormaBotones>		
		</Portal:TablaForma>
		
		<c:if test='${(requestScope.registro.campos["ESTADO_CIVIL"] == "Casado") or (requestScope.registro.campos["ESTADO_CIVIL"] == "Divorciado")}'>
			<Portal:TablaForma maestrodetallefuncion="SimAvalFiadorExConyugeTelefono" nombre="Teléfonos de Cónyuge o Excónyuge" funcion="SimAvalFiadorExConyugeTelefono" operacion="BA">
				<Portal:TablaListaTitulos>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Tel&eacute;fono'/>
					<Portal:Columna tipovalor='texto' ancho='100%' valor='Descripci&oacute;n'/>
				</Portal:TablaListaTitulos>	
				<c:forEach var="registro" items="${requestScope.ListaTelefonoExConyuge}">
					<Portal:TablaListaRenglon>
						<Portal:Columna tipovalor='texto' ancho='150' valor=''>
							<Portal:Url tipo='catalogo' nombreliga='${registro.campos["TELEFONO"]}' funcion='SimAvalFiadorExConyugeTelefono' operacion='CR' parametros='IdTelefono=${registro.campos["ID_TELEFONO"]}&IdPersona=${param.IdPersona}'/>
						</Portal:Columna>
						<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["NOM_DESC_TEL"]}'/>
					</Portal:TablaListaRenglon>
				</c:forEach>
				<Portal:FormaBotones>
					<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimAvalFiadorExConyugeTelefono&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
				</Portal:FormaBotones>		
			</Portal:TablaForma>
			
			<Portal:TablaForma maestrodetallefuncion="SimAvalFiadorExConyugeDireccion" nombre="Direcciones del Cónyuge o Excónyuge" funcion="SimAvalFiadorExConyugeDireccion" operacion="BA">
				<Portal:TablaListaTitulos>
					<Portal:Columna tipovalor='texto' ancho='200' valor='Calle y n&uacute;mero'/>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Colonia'/>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Delegaci&oacute;n o Municipio'/>
				...
				<c:forEach var="registro" items="${requestScope.ListaDireccionExConyuge}">
					<Portal:TablaListaRenglon>
						<Portal:Columna tipovalor='texto' ancho='200' valor=''>
							<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CALLE"]} ${registro.campos["NUMERO_INT"]}' funcion='SimAvalFiadorExConyugeDireccion' operacion='CR' parametros='IdDomicilio=${registro.campos["ID_DOMICILIO"]}&IdPersona=${param.IdPersona}'/>
						</Portal:Columna>
						<Portal:Columna tipovalor='texto' ancho='150' valor='${registro.campos["NOM_ASENTAMIENTO"]}'/>			
						<Portal:Columna tipovalor='texto' ancho='150' valor='${registro.campos["NOM_DELEGACION"]}'/>
						<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["CODIGO_POSTAL"]}'/>
				...
				<Portal:FormaBotones>
					<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimAvalFiadorExConyugeDireccion&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}&IdExConyuge=${param.IdExConyuge}'/>
				</Portal:FormaBotones>		
			</Portal:TablaForma>
		</c:if>

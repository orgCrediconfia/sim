...
<Portal:Pagina funcion="SimGaranteDepositarioExConyugeDireccion">
	<Portal:PaginaNombre titulo="Direcci&oacute;n" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>

	<Portal:Forma tipo='catalogo' funcion='SimGaranteDepositarioExConyugeDireccion' parametros='IdPersona=${param.IdPersona}&IdDomicilio=${param.IdDomicilio}&IdExConyuge=${param.IdExConyuge}'>
	
		<Portal:FormaSeparador nombre="Direcci&oacute;n del Cónyuge o Excónyuge del Garante Depositario"/>				

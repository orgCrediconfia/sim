...
<Portal:Pagina funcion="SimGaranteDepositario" precarga="SimGaranteDepositarioDireccion SimGaranteDepositarioTelefono SimGaranteDepositarioExConyugeDireccion SimGaranteDepositarioExConyugeTelefono">
	<Portal:PaginaNombre titulo="Garante Depositario" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>

	<Portal:Forma tipo='catalogo' funcion='SimGaranteDepositario' parametros='IdPersona=${param.IdPersona}&IdExConyuge=${param.IdExConyuge}'>

		<Portal:FormaSeparador nombre="Datos generales del Garante Depositario"/>
		...
		<Portal:TablaForma maestrodetallefuncion="SimGaranteDepositarioTelefono" nombre="Teléfonos del Garante Depositario" funcion="SimGaranteDepositarioTelefono" operacion="BA">
			...
			<c:forEach var="registro" items="${requestScope.ListaTelefono}">
				<Portal:TablaListaRenglon>
					<Portal:Columna tipovalor='texto' ancho='150' valor=''>
						<Portal:Url tipo='catalogo' nombreliga='${registro.campos["TELEFONO"]}' funcion='SimGaranteDepositarioTelefono' operacion='CR' parametros='IdTelefono=${registro.campos["ID_TELEFONO"]}&IdPersona=${param.IdPersona}'/>
					</Portal:Columna>
					<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["NOM_DESC_TEL"]}'/>
				</Portal:TablaListaRenglon>
			</c:forEach>
			<Portal:FormaBotones>
				<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimGaranteDepositarioTelefono&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
			</Portal:FormaBotones>		
		</Portal:TablaForma>
		
		<Portal:TablaForma maestrodetallefuncion="SimGaranteDepositarioDireccion" nombre="Direcciones del Garante Depositario" funcion="SimGaranteDepositarioDireccion" operacion="BA">
			<Portal:TablaListaTitulos>
			...
			<c:forEach var="registro" items="${requestScope.ListaDireccion}">
				<Portal:TablaListaRenglon>
					<Portal:Columna tipovalor='texto' ancho='200' valor=''>
						<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CALLE"]} ${registro.campos["NUMERO_INT"]}' funcion='SimGaranteDepositarioDireccion' operacion='CR' parametros='IdDomicilio=${registro.campos["ID_DOMICILIO"]}&IdPersona=${param.IdPersona}'/>
					</Portal:Columna>
			...
			<Portal:FormaBotones>
				<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimGaranteDepositarioDireccion&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
			</Portal:FormaBotones>		
		</Portal:TablaForma>
		
		<c:if test='${(requestScope.registro.campos["ESTADO_CIVIL"] == "Casado") or (requestScope.registro.campos["ESTADO_CIVIL"] == "Divorciado")}'>
			<Portal:TablaForma maestrodetallefuncion="SimGaranteDepositarioExConyugeTelefono" nombre="Teléfonos de Cónyuge o Excónyuge" funcion="SimGaranteDepositarioExConyugeTelefono" operacion="BA">
				<Portal:TablaListaTitulos>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Tel&eacute;fono'/>
					<Portal:Columna tipovalor='texto' ancho='100%' valor='Descripci&oacute;n'/>
				</Portal:TablaListaTitulos>	
				<c:forEach var="registro" items="${requestScope.ListaTelefonoExConyuge}">
					<Portal:TablaListaRenglon>
						<Portal:Columna tipovalor='texto' ancho='150' valor=''>
							<Portal:Url tipo='catalogo' nombreliga='${registro.campos["TELEFONO"]}' funcion='SimGaranteDepositarioExConyugeTelefono' operacion='CR' parametros='IdTelefono=${registro.campos["ID_TELEFONO"]}&IdPersona=${param.IdPersona}'/>
						</Portal:Columna>
						<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["NOM_DESC_TEL"]}'/>
					</Portal:TablaListaRenglon>
				</c:forEach>
				<Portal:FormaBotones>
					<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimGaranteDepositarioExConyugeTelefono&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}'/>
				</Portal:FormaBotones>		
			</Portal:TablaForma>
			
			<Portal:TablaForma maestrodetallefuncion="SimGaranteDepositarioExConyugeDireccion" nombre="Direcciones del Cónyuge o Excónyuge" funcion="SimGaranteDepositarioExConyugeDireccion" operacion="BA">
				<Portal:TablaListaTitulos>
					<Portal:Columna tipovalor='texto' ancho='200' valor='Calle y n&uacute;mero'/>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Colonia'/>
					<Portal:Columna tipovalor='texto' ancho='150' valor='Delegaci&oacute;n o Municipio'/>
				...
				<c:forEach var="registro" items="${requestScope.ListaDireccionExConyuge}">
					<Portal:TablaListaRenglon>
						<Portal:Columna tipovalor='texto' ancho='200' valor=''>
							<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CALLE"]} ${registro.campos["NUMERO_INT"]}' funcion='SimGaranteDepositarioExConyugeDireccion' operacion='CR' parametros='IdDomicilio=${registro.campos["ID_DOMICILIO"]}&IdPersona=${param.IdPersona}'/>
						</Portal:Columna>
						<Portal:Columna tipovalor='texto' ancho='150' valor='${registro.campos["NOM_ASENTAMIENTO"]}'/>			
						<Portal:Columna tipovalor='texto' ancho='150' valor='${registro.campos["NOM_DELEGACION"]}'/>
						<Portal:Columna tipovalor='texto' ancho='100%' valor='${registro.campos["CODIGO_POSTAL"]}'/>
				...
				<Portal:FormaBotones>
					<Portal:Boton tipo='url' etiqueta='Alta' url='/ProcesaCatalogo?Funcion=SimGaranteDepositarioExConyugeDireccion&OperacionCatalogo=IN&Filtro=Alta&IdPersona=${registro.campos["ID_PERSONA"]}&IdExConyuge=${param.IdExConyuge}'/>
				</Portal:FormaBotones>		
			</Portal:TablaForma>
		</c:if>

...
<Portal:Pagina funcion="SimClienteExConyugeTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos del Cónyuge o Excónyuge del Cliente" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimClienteExConyugeTelefono' parametros='IdPersona=${param.IdPersona}&IdTelefono=${param.IdTelefono}&IdExConyuge=${param.IdExConyuge}'>

...
<Portal:Pagina funcion="SimNegocioTelefono">
	...
	<Portal:Forma tipo='catalogo' funcion='SimNegocioTelefono' parametros='IdPersona=${param.IdPersona}&IdExConyuge=${param.IdExConyuge}&IdTelefono=${param.IdTelefono}&IdNegocio=${param.IdNegocio}&IdDomicilio=${param.IdDomicilio}'>

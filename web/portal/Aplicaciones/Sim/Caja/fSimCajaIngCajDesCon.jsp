...
<Portal:Pagina funcion="SimCajaIngresoCajaDesembolsar">
	...
	<Portal:TablaLista tipo="consulta" nombre="Ingreso en caja para desembolsar">
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				...
				<Portal:Columna tipovalor='texto' ancho='80' valor='${registro.campos["F_APLICACION"]}'/>
	...
	<script>
		...
		if (document.frmRegistro.IdTransaccion.value != "null"){
			MM_openBrWindow('/portal/ProcesaReporte?Funcion=SimCajaIngresoCajaDesembolsar&TipoReporte=Pdf&Reimpresion=0&IdCaja='+document.frmRegistro.IdCaja.value+'&IdTransaccion='+document.frmRegistro.IdTransaccion.value,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
		}
	</script>
</Portal:Pagina>
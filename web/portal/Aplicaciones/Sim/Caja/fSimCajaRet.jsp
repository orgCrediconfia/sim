...
<Portal:Pagina funcion="SimCajaRetiro">
	...
	<script>
		function fAceptar(){
			MM_openBrWindow('/portal/ProcesaCatalogo?Funcion=SimGeneralesFirmaElectronica&OperacionCatalogo=CR&Modulo=Caja&IdCajero=1&IdCoordinador=1&IdGerente=No&IdCaja='+document.frmRegistro.IdCaja.value+'&Ventana=Si&ValidaCajero=SI','VentanaCp','scrollbars=yes,resizable=yes,width=500,height=300');
		}
	</script>

...
<Portal:Pagina funcion="SimUsuarioDireccion">
	<Portal:PaginaNombre titulo="Direcci&oacute;n" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>

	<Portal:Forma tipo='catalogo' funcion='SimUsuarioDireccion' parametros='CveUsuario=${param.CveUsuario}&IdPersona=${param.IdPersona}&IdDomicilio=${param.IdDomicilio}'>
	
		<Portal:FormaSeparador nombre="Direcci&oacute;n del Usuario"/>				

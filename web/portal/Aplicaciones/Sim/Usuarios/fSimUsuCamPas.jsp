...
<Portal:Pagina funcion="SimUsuarioCambiarPassword">
	<Portal:PaginaNombre titulo="Cambiar Password" subtitulo="Modificaci&oacuten de datos" subtituloalta=""/>
	
	<Portal:Forma tipo='catalogo' funcion='SimUsuarioCambiarPassword'>
	...
	function ValidaPassword() {
		...
		if (p1==""){
			...
			document.frmRegistro.action="ProcesaCatalogo?Funcion=SimUsuarioCambiarPassword&OperacionCatalogo=MO&PasswordActual="+document.frmRegistro.PasswordActual.value+"&Password="+document.frmRegistro.Password.value;

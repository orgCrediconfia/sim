...
<Portal:Pagina funcion="SimUsuarioRegionalGerente">
	<Portal:PaginaNombre titulo="Gerentes de Regionales" subtitulo="Consulta de datos"/>
	
	<Portal:Forma tipo='busqueda' funcion='SimUsuarioRegionalGerente' operacion='CT' filtro='Todos'>
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='100' valor=''>
					<Portal:Url tipo='catalogo' nombreliga='${registro.campos["CVE_USUARIO"]}' funcion='SimUsuarioRegionalGerente' operacion='CR' parametros='CveUsuario=${registro.campos["CVE_USUARIO"]}&IdPersona=${registro.campos["ID_PERSONA"]}' parametrosregreso='\'${registro.campos["CVE_USUARIO"]}\', \'${registro.campos["NOM_COMPLETO"]}\''/>
				</Portal:Columna>

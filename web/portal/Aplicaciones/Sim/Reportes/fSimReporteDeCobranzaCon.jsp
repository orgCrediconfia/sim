	...
	<Portal:Forma tipo='url' funcion='SimReporteDeCobranza' url="ProcesaReporte?Funcion=SimReporteDeCobranza&TipoReporte=Xls" agregaentorno="false">
     ...
     <script>
         function fReporteXls(){
              ...
              url = '/portal/ProcesaReporte?Funcion=SimReporteDeCobranza&TipoReporte=Xls&CvePrestamoGpo='+document.frmRegistro.CvePrestamoGpo.value;
       ...
       function fReportePdf(){
          ...
          url = '/portal/ProcesaReporte?Funcion=SimReporteDeCobranza&TipoReporte=Pdf&CvePrestamoGpo='+document.frmRegistro.CvePrestamoGpo.value;
          MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
        }
  }
     </script>

...
<Portal:Pagina funcion="SimReporteAntiguedad">
	...
	<Portal:PaginaNombre titulo="Reporte de saldos y antigüedad de capital vencido" subtitulo="Consulta del reporte"/>
	...
	<Portal:Forma tipo='url' funcion='SimReporteAntiguedad' url="ProcesaReporte?Funcion=SimReporteAntiguedad&TipoReporte=Xls" agregaentorno="false">
     ...
     <script>
         ...
         function fReporteXls(){
              url = '/portal/ProcesaReporte?Funcion=SimReporteAntiguedad&TipoReporte=Xls&IdRegional='+document.frmRegistro.IdRegional.value+'&IdSucursal='+document.frmRegistro.IdSucursal.value+'&CveUsuario='+document.frmRegistro.CveUsuario.value;
          	  MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
         }
       
      
         function fReportePdf(){
              url = '/portal/ProcesaReporte?Funcion=SimReporteAntiguedad&TipoReporte=Pdf&IdRegional='+document.frmRegistro.IdRegional.value+'&IdSucursal='+document.frmRegistro.IdSucursal.value+'&CveUsuario='+document.frmRegistro.CveUsuario.value;
              MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
        }
     </script>

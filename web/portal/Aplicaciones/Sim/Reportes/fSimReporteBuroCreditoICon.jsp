...
<Portal:Pagina funcion="SimReporteBuroCreditoG">
	...
	<Portal:PaginaNombre titulo="Reporte de buro de credito individual" subtitulo="Consulta del reporte"/>
	
	<Portal:Forma tipo='url' funcion='SimReporteBuroCreditoI' url="ProcesaReporte?Funcion=SimReporteBuroCreditoI&TipoReporte=Xls" agregaentorno="false">
     ...
     <script>
         ...
         function fReporteXls(){
              url = '/portal/ProcesaReporte?Funcion=SimReporteBuroCreditoI&TipoReporte=Xls&CvePrestamoGrupo='+document.frmRegistro.CvePrestamoGrupo.value;
              MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
         }
       
      
         function fReporteCsv(){
              url = '/portal/ProcesaReporte?Funcion=SimReporteBuroCreditoI&TipoReporte=Csv&CvePrestamoGrupo='+document.frmRegistro.CvePrestamoGrupo.value;
              	MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
        }
     </script> 

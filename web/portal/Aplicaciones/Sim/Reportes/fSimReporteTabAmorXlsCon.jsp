...
<Portal:Pagina funcion="SimReporteTabAmorXls">

	<Portal:PaginaNombre titulo="Reporte de tabla de amortización individual" subtitulo="Consulta del reporte"/>
	
	<Portal:Forma tipo='url' funcion='SimReporteTabAmorXls' url="ProcesaReporte?Funcion=SimReporteTabAmorXls&TipoReporte=Xls" agregaentorno="false">
     ...
     <script>
         function fReporteXls(){
              ...
              url = '/portal/ProcesaReporte?Funcion=SimReporteTabAmorXls&TipoReporte=Xls&CvePrestamo='+document.frmRegistro.CvePrestamo.value;
       ...
       function fReportePdf(){
          ...
          url = '/portal/ProcesaReporte?Funcion=SimReporteTabAmorXls&TipoReporte=Pdf&CvePrestamo='+document.frmRegistro.CvePrestamo.value;
          MM_openBrWindow(url,'Reporte','status=yes,scrollbars=yes,resizable=yes,width=700,height=400');
        }
  }
     </script>

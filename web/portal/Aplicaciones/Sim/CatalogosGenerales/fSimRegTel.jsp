...
<Portal:Pagina funcion="SimRegionalTelefono">
	<Portal:PaginaNombre titulo="Tel&eacute;fonos" subtitulo="Modificaci&oacute;n de datos" subtituloalta="Alta de datos"/>
	<Portal:Forma tipo='catalogo' funcion='SimRegionalTelefono' parametros='IdRegional=${param.IdRegional}&IdTelefono=${param.IdTelefono}&IdDomicilio=${param.IdDomicilio}'>

...
<Portal:Pagina funcion="SimCatalogoCargoComision">
	...
	<Portal:Forma tipo='busqueda' funcion='SimCatalogoCargoComision' operacion='CT' filtro='Todos'>
		<Portal:FormaElemento etiqueta='Clave' control='Texto' controlnombre='IdCargoComision' controllongitud='5' controllongitudmax='5' validadato='cantidades'/>

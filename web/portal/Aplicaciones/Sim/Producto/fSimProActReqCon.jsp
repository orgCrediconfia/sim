...
<Portal:Pagina funcion="SimProductoActividadRequisito">
	...
	<Portal:Forma tipo='busqueda' funcion='SimProductoActividadRequisito' operacion='CT' filtro='Todos' parametros='AplicaA=${param.AplicaA}&IdProducto=${param.IdProducto}'>

...
<Portal:Pagina funcion="SimPrestamoCancelacionLiquidacionDefuncion">
	<Portal:PaginaNombre titulo="Créditos liquidados por defunción" subtitulo="Consulta de datos"/>
	...
	<Portal:TablaLista tipo="consulta" nombre="Consulta">
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='100' valor=''>	
				    <input type="button" name="CancelarLiquidacionDefuncion"  value="Cancelar Liquidación por Defunción" onclick="javascript:fCancelarLiquidacionDefuncion('<c:out value='${registro.campos["ID_PRESTAMO"]}'/>','<c:out value='${registro.campos["APLICA_A"]}'/>')">
				</Portal:Columna>

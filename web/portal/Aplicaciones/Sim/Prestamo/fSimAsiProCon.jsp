...
<Portal:Pagina funcion="SimAsignaProducto">
	<Portal:PaginaNombre titulo="Producto" subtitulo="Consulta de datos"/>
	<Portal:Forma tipo='busqueda' funcion='SimAsignaProducto' operacion='CT' filtro='Todos' parametros='IdGrupo=${param.IdGrupo}'>
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='100' valor=''>
					...
					\'${registro.campos["APLICA_A"]}\', \'${registro.campos["VALOR_TASA"]}\', \'${registro.campos["PLAZO"]}\', 
					\'${registro.campos["ID_PERIODICIDAD"]}\', \'${registro.campos["CVE_METODO"]}\', \'${registro.campos["MONTO_MAXIMO"]}\''/> 
				</Portal:Columna>	
	...
	<script>
		function RegresaDatos(IdProducto, NomProducto, AplicaA, ValorTasa, Plazo, IdPeriodicidadProducto, CveMetodo, MontoMaximo){

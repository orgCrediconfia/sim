...
<Portal:Pagina funcion="SimPrestamoFlujoEfectivo">
	<Portal:PaginaNombre titulo="Flujo de efectivo" subtitulo="Consulta de datos"/>
	
	<Portal:Forma tipo='busqueda' funcion='SimPrestamoFlujoEfectivo' operacion='CT' filtro='Todos'>
		...
		<c:forEach var="registro" items="${requestScope.ListaBusqueda}">		
			<Portal:TablaListaRenglon>
				<Portal:Columna tipovalor='texto' ancho='50' valor=''>					
					<Portal:Url tipo='catalogo' nombreliga='${registro.campos["ID_PRESTAMO"]}' funcion='SimPrestamoFlujoEfectivo' operacion='IN' parametros='Filtro=Alta&IdPrestamo=${registro.campos["ID_PRESTAMO"]}'/>
				</Portal:Columna>
